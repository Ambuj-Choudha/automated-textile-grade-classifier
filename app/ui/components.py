"""Shared UI components used across screens (logo, image viewer, and the
result/status views on capture screens)."""
import os
...
def show_image_viewer() -> None:
    ...
    (Reachable to the operator today; step 3 will move it behind the admin panel.)
    """
    valid_folders = [
